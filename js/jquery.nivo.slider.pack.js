...
(function(e){var t=function(t,n){
	...
	var s=e(t);s.data("nivo:vars",i).addClass("nivoSlider");
	var o=s.children();
	o.each(function(){
		var t=e(this);
		var n="";
		if(!t.is("img")){if(t.is("a")){t.addClass("nivo-imageLink");
		n=t}t=t.find("img:first")}var r=r===0?t.attr("width"):t.width(),s=s===0?t.attr("height"):t.height();
		if(n!==""){n.css("display","none")}t.css("display","none");
		i.totalSlides++});
	if(r.randomStart){
...
var a=function(t){var n=e(".nivo-caption",s);
if(i.currentImage.attr("title")!=""&&i.currentImage.attr("title")!=undefined){
	...
	if(r.directionNav){
		...
		e(s).on("click","a.nivo-prevNav",function(){
			if(i.running){return false}clearInterval(f);
			f="";
			i.currentSlide-=2;
			d(s,o,r,"prev")
		});
...
if(r.pauseOnHover){
	s.hover(function(){
		...
		if(f===""&&!r.manualAdvance){
			f=setInterval(function(){d(s,o,r,false)},r.pauseTime)
		}
	}
	)
...
/* ---------------------------------------------- */
/* ------- Photo transition effect change ------- */
/* ---------------------------------------------- */
/* change the array and o= to the ones of choice  */
			...
			if(o==="sliceDown"||o==="sliceDownRight"||o==="sliceDownLeft"){
				...
				d.each(function(){
					...
					if(c===r.slices-1){
						...
						setTimeout(function(){
							n.animate({opacity:"1.0"},r.animSpeed)},100+l)
					}l+=50;c++})
				...
				var b=0;
				d=e(".nivo-slice",t);
				if(o==="sliceUpDownLeft"){d=e(".nivo-slice",t)._reverse()}d.each(function(){
					var n=e(this);
					if(c===0){
						n.css("top","0px");
						c++
					...
					if(b===r.slices-1){
						setTimeout(function(){
							...
							setTimeout(function(){
								n.animate({opacity:"1.0"},r.animSpeed)},100+l)}l+=50;
							b++
						})
			}else if(o==="fold"){
				h(t,r,s);
					...
					if(c===r.slices-1){
						setTimeout(function(){
							n.animate({width:i,opacity:"1.0"},r.animSpeed,"",function(){
								t.trigger("nivo:animFinished")})},100+l)
					}else{
						setTimeout(function(){
						...
						if(T>=0&&T<r.boxCols){
							(function(n,i,s,u,a){
								...
								if(u===a-1){
									...
									setTimeout(function(){
										f.animate({opacity:"1",width:l,height:c},r.animSpeed/1.3)},100+s)
								}
							})(N,T,l,c,g);
							c++
						}T--
			...
			this.stop=function(){
				if(!e(t).data("nivo:vars").stop){
					...
					e.fn.nivoSlider.defaults={
						effect:"random",slices:15,boxCols:8,boxRows:4,animSpeed:500,pauseTime:3e3,startSlide:0,directionNav:true,controlNav:true,controlNavThumbs:false,pauseOnHover:true,manualAdvance:false,prevText:"Prev",nextText:"Next",randomStart:false,beforeChange:function(){},afterChange:function(){},slideshowEnd:function(){},lastSlide:function(){},afterLoad:function(){}};
